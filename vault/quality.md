...
2026-08-18 audit, against `main` (`git log -1`: PR #14 merged); other
commands as noted otherwise. Run from the repo root.
...
Prettier enforced as a lint rule. **Verified passing** 2026-08-18.
...
2026-08-18, `strict: true` plus `noUnusedLocals`,
...
passing** 2026-08-18 — ~1s, one non-blocking warning about the main JS
chunk exceeding 500kB (580.12kB as of this audit, up from 577.01kB at
